...
8. Details for running energy calculation, geometrty minimization and molecular dynamics simulation by calling Tinker-GPU could be found in [TinkerGPU_py](../../docs/tinker9nn_py.md) and [TinkerGPU_cuda](https://tinker9-manual.readthedocs.io/en/latest/m/key/nn.html). 

...
For detailed instructions on model training / testing, see [AMOEBA+NN: Model Training and Testing](docs/nn_training.md)
...
For metal ions (e.g., $Cu^{2+}$), the NNP acts as a correction term to capture complex many-body effects (like Jahn-Teller distortion). Data and training details can be found in [AMOEBA+NN: Metal ion model](data/copper/README.md)
